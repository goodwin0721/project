...
public class GoodsServiceTest {
	...
	public void test_addGoods() {
		...
		goodsService.addGoods("测试", "123", "1", "1", "fruits", base64Img);
	}
	
	@Test
	public void test_getHotSale() {
		List<Goods> list = goodsService.getHotSale(10);
	...
	public void test_searchByKeyword() {
		List<Goods> list = goodsService.searchByKeyword("萝卜");
		for (Goods goods : list) {
			System.out.println(goods);
		}
	}
	...
	@Test
	public void test_searchByLClassify() {
		List<Goods> list = goodsService.searchByClassify("toy");
		for (Goods goods : list) {
			System.out.println(goods);
		}
	}
	...
	@Test
	public void test_addStockById() {
		goodsService.addStockById("0", "100");
	}
	@Test
	public void test_subStockById() {
		goodsService.subStockById("0", "1");
	}
}
