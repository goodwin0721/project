...
<body>
	...
	<div id="content">
		<div id="position">
			<span>你的位置&gt;</span>		
			<a href="<%=request.getContextPath()%>/showPageServlet?currentPage=index">首页</a>
			<span>&gt;</span>
			<span>${keyword}</span>
		</div>
		...
		没有找到“${keyword}”相关商品，<a href="<%=request.getContextPath()%>/showPageServlet?currentPage=index">返回首页</a>
		或重新搜索。
		</div>	
		</c:if>
		<div class="goodsList">		
